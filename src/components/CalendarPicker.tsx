      ...
      <>
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            ...
            className="text-[16px] font-medium text-[#1A1A1A] hover:text-[#5D5278] transition-colors"
              ...
              return (
                <button
                  ...
                  className={`
                    ...
                    ${inMonth && !isSelected && !isFuture ? 'text-[#1A1A1A] hover:bg-[#F2D8B0]' : ''}
                    ${isSelected ? 'bg-gradient-to-br from-[#5D5278] via-[#A8978E] to-[#C8AAAA] text-white' : ''}
                ...
                >
                  ...
                  {/* Data indicator dot */}
                  {hasData && !isSelected && (
                    <span className={`absolute bottom-1 w-1.5 h-1.5 rounded-full ${over ? 'bg-[#DC2626]' : 'bg-[#5D5278]'}`} />
                  )}
                  {hasData && isSelected && (
            ...
            return (
              <button
                ...
                className={`
                  ...
                  ${isCurrentMonth ? 'bg-gradient-to-br from-[#5D5278] via-[#A8978E] to-[#C8AAAA] text-white' : ''}
                  ${!isCurrentMonth && !isFuture ? 'text-[#1A1A1A] hover:bg-[#F2D8B0]' : ''}
                  ${isFuture ? 'text-gray-200 cursor-not-allowed' : ''}
                `}
                style={{ fontFamily: 'DM Sans' }}
              >
                ...
                {hasData && !isCurrentMonth && (
                  <span className="absolute top-1.5 right-1.5 w-1.5 h-1.5 rounded-full bg-[#5D5278]" />
                )}
              </button>
            );
          })}
            ...
            return (
              <button
                ...
                className={`
                  ...
                  ${isSelected && inDecade ? 'bg-gradient-to-br from-[#5D5278] via-[#A8978E] to-[#C8AAAA] text-white' : ''}
                  ${!isSelected && inDecade && !isFuture ? 'text-[#1A1A1A] hover:bg-[#F2D8B0]' : ''}
                  ${isFuture ? 'text-gray-200 cursor-not-allowed' : ''}
                `}
                style={{ fontFamily: 'DM Sans' }}
              >
      ...
      <div className="max-w-[700px] mx-auto px-6 md:px-12 py-4">
        ...
        <div className="mt-3 text-center">
          <button
            ...
            className="text-[13px] text-[#5D5278] hover:underline"
            style={{ fontFamily: 'DM Sans' }}
          >
            Go to today
          </button>
